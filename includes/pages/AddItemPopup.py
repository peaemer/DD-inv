...
from includes.pages._styles import size_add_item_popup, srh_grey, corner, comboborder, srh_grey_hover
...
class AddItemPopup2(IPopUp):
    ...
    def add_content(self, content_frame: tk.Frame):
        ...
        # Name
        self.name_label = tk.Label(content_frame,
                                             text="Name",
                                             background="white",
                                             font=("Arial", size_add_item_popup)
                                             )
        ...
        # Beschädigung
        self.damage_label = tk.Label(content_frame,
                                                text="Beschädigung",
                                                background="white",
                                                font=("Arial", size_add_item_popup)
                                                )
