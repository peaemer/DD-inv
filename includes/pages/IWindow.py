...
class IWindow(tkinter.Frame, ABC):
    """
        ...
        The frames are the header frame at the top of the window, two sidebar frames and the main frame in the middle of the window.
        Classes that inherit from IWindow can access these frames only through the setup methods. These are created inside the
        constructor of IWindow.
    """
    ...
    def setup_side_bar_left(self, frame:tkinter.Frame) -> bool:
        """
            ...
            If the method returns False, the left sidebar will start from the bottom and end at the bottom of the
            header frame. The header frame would extend to the left of the window.
        """
    ...
    def setup_side_bar_right(self, frame:tkinter.Frame) -> bool:
        """
            ...
            narrowing the header frame.
            If the method returns False, the right sidebar will start from the bottom and end at the bottom of the
            header frame. The header frame would extend to the right of the window.
        """
    ...
    def __init__(self, parent:tkinter.Widget, controller, admin_mode:bool=False, ):
        """
