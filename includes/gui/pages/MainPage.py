...
class MainPage(IPage):
    ...
    def __init__(self, parent, controller):
        ...
        self.add_btn = tk.PhotoImage(Paths.assets_path("Erstellen.png"))
        ...
        search_entry_oval:CTkEntry = CTkEntry(search_frame,
                                              ...
                                              border_width=0,
                                              height=25)
        search_entry:Searchbar = Searchbar(self, search_frame, dropdown, cache.user_name)
        ...
        from .DetailsPage import show_details
