...
from includes.gui.pages.detailPages import UserDetailsWindow
...
class AdminUserPage(AdminPage):
    ...
    @override
    def on_cell_click(self, data:dict[str,str]) -> None:
        UserDetailsWindow.show_user_details(data, self.controller),
