...
from ....windows import sort_column
import customtkinter as ctk


# Hauptseite (zweites Fenster)
class AdminRoomPage(tk.Frame):
    """
    ...
    def __init__(self, parent, controller):
        ...
        # Scrollbar erstellen
        room_tree_scroll = ctk.CTkScrollbar(room_tree_frame,
        ...
        def on_room_selected(event):
            try:
                ...
                if selected_room:
                    from includes.windows.RoomDetailsWindow import RoomDetailsWindow, show_room_details
