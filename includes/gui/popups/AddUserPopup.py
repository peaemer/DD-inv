...
from includes.windows._styles import srh_grey, corner, comboborder, srh_grey_hover, size_add_user_popup, border
...
class AddUserPopup(IPopUp):
    ...
    def submit_entry(self):
        ...
        if not self.username_entry.get() or self.username_entry.get() == "" or not self.role_combobox.get() or self.role_combobox.get() == "Rolle auswählen":
            ...
            from ..pages.adminPages.AdminUserPage import AdminUserWindow
